    ...
    <div class="container">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content text-right p-2 pb-1 rounded-lg font-weight-bold">
                      <div class="modal-header" style="border-bottom: 0px;">
                        <h5 class="modal-title lead-6 text-primary font-weight-bold " id="exampleModalLabel">تسجيل الدخول</h5>
                      </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content text-right rounded-lg">
              <div class="modal-header" style="border-bottom: 0px;">
                <h5 class="modal-title lead-3 text-primary font-weight-bold mx-auto w-50" id="exampleModalLabel">شكراً لإستخدامك توريدة </h5>
              </div>
