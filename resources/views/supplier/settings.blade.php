      ...
      <form action="{{route('supplier.settings')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
            ...
            <select id="dept" type="text" name="departments[]" id="type" placeholder="" class="select form-control rounded-lg" multiple>
          ...
          <div class="form-group col-md-6">
            ...
            <select id="category" type="text" name="categories[]" id="type" placeholder="" class="select form-control rounded-lg" multiple>
