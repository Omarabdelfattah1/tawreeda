...
<div class="col-lg-4 col-md-6 col-sm-8 text-center mb-6">
  <div class="card shadow-lg px-2 pb-3 mx-auto" style="position: relative;margin-top: 20%;">
    ...
    <img src="{{asset('storage/'.$supplier->company_logo)}}" class="mx-auto pt-6" alt="" style="width:35%;position: absolute; top:-50%;left:32.5%;z-index: 11;padding-top: 50px;">
    </a>
    ...
    <div class="d-flex mt-3 fs-6 p-1 text-center">
      ...
      <div class="btn btn-xs btn-secondary text-default mx-auto" >أكواب ورقية</div>
    </div>
  </div>
</div>
@endforeach