                ...
                <div class="">
                  ...
                  <div class="row mr-1  mt-3">
                    ...
                    <div class="media">
                      ...
                      <h6 style="font-size: 12px;" class="ml-2">+201213435423</h6>
            ...
            <div class="row m-3 justify-content-between border-bottom pb-3">
              <div class="col-md-6">
                ...
                <p style="line-height: 20px;">
                  مطلوب 2000 كوباية ورق 7 أونص <br> و 4000 كوباية ورق 9 أونص <br> و 1000 كوباية ورق 12.5 أونص <br>
                  لونين  و مطبوع عليهم الللوجو
                  <br>
                  <br>
                  محتاج التوصيل يكون في خلال 10 أيام للمخزن في مصر الجديدة <br>
                  الدفع بعد 30 يوم <br>
                  محتاجين فواتير ضريبية
                </p>
              </div>
                ...
                <div  class="d-flex mt-6 justify-content-between rounded-lg p-4" style="border: 2px solid #C39B324F !important">
                  <div class="media">
                      ...
                      <div>
                        ...
                        <p style="font-size: xx-samall;">3.5mb</p>
                      </div>
                  </div>
                  <button class="btn btn-default" style="padding: 0;font-size: 20px;">
                    <i class="fa fa-download text-primary" ></i>
                  </button>                    
                </div>
                <div  class="d-flex mt-3 justify-content-between rounded-lg p-4" style="border: 2px solid #C39B324F !important">
                  <div class="media">
                      <img src="{{asset('assets/xd/attachment.svg')}}" style="width: 50px;" class="ml-2" alt="">
                      <div>
                        <h6 class="mb-3">Document File</h6>
                        <p style="font-size: xx-samall;">3.5mb</p>
                      </div>
                ...
                <div class="row justify-content-between">
                  ...
                  <div class="col-md-6 row mb-4 " style="background-color: #FAFAFA;">
                    ...
                    <div class="col-md-2 py-5 px-0">
                      <a href="{{route('dashboard.offers.show',$offer)}}" class="btn btn-sm rounded-lg text-primary my-6" style="background-color: #FFF4EC;" >التفاصيل</a>
                    </div>
